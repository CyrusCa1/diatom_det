...
from high_scale.nets import get_model_from_name
from high_scale.utils.utils import (cvtColor, get_classes, letterbox_image,
...
class Classification(object):
    _defaults = {
        ...
        # --------------------------------------------------------------------------#
        # "model_path": r'./logs/high_scale.pth',
        # "classes_path": r'./high_scale/cls_classes.txt',
        # --------------------------------------------------------------------#
        #   输入的图片大小
        # --------------------------------------------------------------------#
        "input_shape": [512, 512],
    ...
    def __init__(self, **kwargs):
        ...
        #   获得种类
        # ---------------------------------------------------#
        self.class_names, self.num_classes = get_classes(self.class_mapping)
        # self.class_names, self.num_classes = get_classes(classes_path=self.classes_path)
        self.generate()
